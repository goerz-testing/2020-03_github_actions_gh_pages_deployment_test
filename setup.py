...
VERSION = get_version('./src/github_actions_gh_pages_deployment_test/__init__.py')
...
setup(
    ...
    keywords='github_actions_gh_pages_deployment_test',
    name='github_actions_gh_pages_deployment_test',
    packages=find_packages(where="src"),
    package_dir={"": "src"},
    url='https://github.com/goerz-testing/github_actions_gh_pages_deployment_test',
    version=VERSION,
    zip_safe=False,
)
