...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            os.path.join(ROOT / 'src' / 'github_actions_gh_pages_deployment_test'),
        ]
    )
...
source_suffix = '.rst'
master_doc = 'index'
project = '2020-03 Github Actions gh-pages Deployment Test'
year = str(datetime.datetime.now().year)
author = 'Michael Goerz'
copyright = '{0}, {1}'.format(year, author)
version = github_actions_gh_pages_deployment_test.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': ('https://github.com/goerz-testing/github_actions_gh_pages_deployment_test/issues/%s', '#'),
    'pr': ('https://github.com/goerz-testing/github_actions_gh_pages_deployment_test/pull/%s', 'PR #'),
}
